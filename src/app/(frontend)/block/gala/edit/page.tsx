...
if (showSuccessMessage) {
 ...
 />
  ...
  <div className="min-h-screen max-w-7xl mx-auto bg-gray-50 dark:bg-black ">
   ...
   {[
     { label: 'Gala Type', key: 'GalaType', type: 'select', options: ['Brown', 'White'] },
     { label: 'Vendor Name', key: 'vender_id', type: 'vendor' },
     { label: 'Munim', key: 'munim' },
     { label: 'Length (लम्बाई)', key: 'l' },
     { label: 'Front Breadth (चौड़ाई)', key: 'front_b' },
     { label: 'Back Breadth (चौड़ाई)', key: 'back_b' },
     { label: 'Total Breadth (चौड़ाई)', key: 'total_b' },
     { label: 'Height (ऊंचाई)', key: 'h' },
     { label: 'Gala Cost', key: 'gala_cost' },
     { label: 'Hydra Cost', key: 'hydra_cost' },
     { label: 'Truck Cost', key: 'truck_cost' },
     { label: 'Total Gala Area', key: 'total_gala_area', editable: "disabled" },
     { label: 'Total Gala Cost', key: 'total_gala_cost', editable: "disabled" },
     { label: 'Estimate Cost', key: 'estimate_cost', editable: "disabled" },
         ...
         <div key={name}>
           ...
           <input
             ...
             onChange={(e) => {
               ...
               const gala = parseFloat(newBlock?.gala_cost || '0')
               
               // Update group total cost
               const groupTotalCost = groupTotalArea * (truck + hydra + gala)
               ...
               group.block?.forEach((block, bIdx) => {
                 ...
                 const blockCost = blockArea * (truck + hydra + gala)
               ...
               const totalBlockCost = totalBlockArea * (truck + hydra + gala)
                 ...
                 <div key={name}>
                   ...
                   <input
                     ...
                     onChange={(e) => {
                       ...
                       const gala = parseFloat(newBlock?.gala_cost || '0') || 0
