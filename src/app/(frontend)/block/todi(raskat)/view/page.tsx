    ...
    <div className="mb-8 p-4 border border-gray-200 rounded-lg">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="border p-3 rounded">
          <p className="text-sm text-gray-500">Total Delevered Todi Area (m³)</p>
        ...
        {/* Total Todi Cost */}
        <div className="border p-3 rounded">
          <p className="text-sm text-gray-500">Total Delevered Todi Cost (₹)</p>
          <p className="text-xl font-bold">
        ...
        {/* Final Cost */}
        <div className="border p-3 rounded">
          <p className="text-sm text-gray-500">Delevered Final Cost (₹)</p>
          <p className="text-xl font-bold">
